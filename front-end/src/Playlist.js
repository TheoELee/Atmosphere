			...
			<div>
                ...
                <Card>
                    <Container fluid>
                        <Row>
                            <Col>
                                <Card.Body>1. <img width="50" height="50" src={albumArt[0]}></img> {tracks[0]} - {artists[0]} - {albums[0]}</Card.Body>
                            </Col>
                        </Row>
                    </Container>
                </Card>
                <Card>
                    <Container fluid>
                        <Row>
                            <Col>
                                <Card.Body>2. <img width="50" height="50" src={albumArt[1]}></img> {tracks[1]} - {artists[1]} - {albums[1]}</Card.Body>
                            </Col>
                        </Row>
                    </Container>
                </Card>
                <Card>
                    <Container fluid>
                        <Row>
                            <Col>
                                <Card.Body>3. <img width="50" height="50" src={albumArt[2]}></img> {tracks[2]} - {artists[2]} - {albums[2]}</Card.Body>
                            </Col>
                        </Row>
                    </Container>
                </Card>
                <Card>
                    <Container fluid>
                        <Row>
                            <Col>
                                <Card.Body>4. <img width="50" height="50" src={albumArt[3]}></img> {tracks[3]} - {artists[3]} - {albums[3]}</Card.Body>
                            </Col>
                        </Row>
                    </Container>
                </Card>
                <Card>
                    <Container fluid>
                        <Row>
                            <Col>
                                <Card.Body>5. <img width="50" height="50" src={albumArt[4]}></img> {tracks[4]} - {artists[4]} - {albums[4]}</Card.Body>
                            </Col>
                        </Row>
                    </Container>
                </Card>
